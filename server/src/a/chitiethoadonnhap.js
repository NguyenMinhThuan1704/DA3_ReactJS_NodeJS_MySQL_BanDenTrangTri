...
module.exports = (sequelize, DataTypes) => {
  class ChiTietHoaDonNhap extends Model {
    ...
    static associate(models) {
      ...
      ChiTietHoaDonNhap.belongsTo(models.SanPham, { foreignKey: 'MaSanPham', as: 'sanPham' });
      ChiTietHoaDonNhap.belongsTo(models.HoaDonNhap, { foreignKey: 'MaHoaDonNhap', as: 'hoaDonNhap' });
    }
  }
